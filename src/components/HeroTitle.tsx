...
function GearWithDust({ delay = 0 }: GearWithDustProps) {
  ...
  // Dust particles - completely independent, always floating
  ...
  return (
    <span className="inline-block relative">
      {/* Dust - completely independent, always floating above gear */}
