            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <ScrollReveal key={feature.title} delay={i * 0.1}>
                  <TiltCard>
                    <div className="glass-solid z-20 rounded-2xl p-8 h-56 transition-all duration-300 group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <ScrollReveal key={item.title} delay={i * 0.1}>
                  <TiltCard>
                    <div className="glass-solid z-20 rounded-2xl p-6 transition-all duration-300 group">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <ScrollReveal>
              <div className="max-w-2xl mx-auto">
                <TiltCard>
                  <div className="glass-solid z-20 rounded-2xl p-8 border-2 border-blue-500/30 hover:border-blue-500/60 transition-all duration-300 group">
            ...
            <div className="space-y-4">
              {[
                ...
                <ScrollReveal key={faq.q} delay={i * 0.1}>
                  <div className="glass-solid z-20 rounded-xl p-6 transition-all duration-300 group cursor-pointer">
