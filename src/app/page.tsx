              ...
              <TiltCard className="md:col-span-2 md:row-span-1">
                <div className="glass rounded-2xl p-8 hover:bg-white/5 transition-all cursor-pointer group h-full min-h-[180px]">
                  ...
                  <p className="text-gray-400">
                    Build complex automations with our drag-and-drop visual builder. No coding required - just connect the dots.
                  </p>
                </div>
              </TiltCard>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400">
                  Share your business processes and pain points. We'll listen and understand your workflow.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400">
                  Our team creates custom automations tailored to your specific business needs.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-400">
                  Your automations start working immediately. Sit back and enjoy your free time.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-24 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                We're not just another automation tool. We're your partner in efficiency.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="glass rounded-2xl p-6">
                ...
                <p className="text-gray-400 text-sm">
                  A fraction of the cost of hiring an employee or using enterprise tools.
                </p>
              </div>
              ...
              <div className="glass rounded-2xl p-6">
                ...
                <p className="text-gray-400 text-sm">
                  We build everything for you. No learning curve, no technical knowledge needed.
                </p>
              </div>
              ...
              <div className="glass rounded-2xl p-6">
                ...
                <p className="text-gray-400 text-sm">
                  Direct access to our team. No chatbots, no waiting in queue.
                </p>
              </div>
      ...
      <ScrollReveal>
        <section className="py-24 px-6 bg-white/[0.02]">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-4">
                Loved by <span className="gradient-text-accent">businesses</span>
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="glass rounded-2xl p-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">Founder, TechStartup</p>
                  </div>
                </div>
              </div>
              ...
              <div className="glass rounded-2xl p-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">Owner, LocalBiz</p>
                  </div>
                </div>
              </div>
              ...
              <div className="glass rounded-2xl p-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white font-medium">Mike K.</p>
                    <p className="text-gray-500 text-sm">CEO, GrowthCo</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section id="pricing" className="py-24 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                One-time setup fee + monthly maintenance. No hidden costs.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="glass rounded-3xl p-12">
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                Ready to <span className="gradient-text-accent">save time</span>?
              </h2>
              <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
                Join hundreds of businesses already benefiting from custom automations. 
